...
export function CreateIncidenceMutation() {
    const queryClient = useQueryClient()
    return useMutation((payload) => {return apiClient.post('/v4/incidence/', {'journey':payload.journey, 'info':payload.info})}, {
        onMutate: async () => {
        },
        ...
        onSuccess: (info, variables) => {
            ...
            MySwal.fire({
              ...
              return MySwal.fire(<p>Incidence created succesfully!</p>)
            })
